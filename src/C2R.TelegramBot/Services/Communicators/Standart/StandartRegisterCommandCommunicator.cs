...
{
    public class StandartRegisterCommandCommunicator : IRegisterCommandCommunicator
    {
        [NotNull]
        private readonly IBotService _botService;

        public StandartRegisterCommandCommunicator([NotNull] IBotService botService)
        {
