...
{
    public class StandartUnregisterCommandCommunicator : IUnregisterCommandCommunicator
    {
        [NotNull]
        private readonly IBotService _botService;

        public StandartUnregisterCommandCommunicator([NotNull] IBotService botService)
        {
